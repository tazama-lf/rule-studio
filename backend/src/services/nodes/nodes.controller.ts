...
export class NodesController {
    ...
    @ApiQuery({ name: 'limit', required: false, type: Number, description: 'Maximum number of nodes to return', example: 50 })
    @ApiQuery({ name: 'offset', required: false, type: Number, description: 'Starting position for pagination', example: 0 })
    @ApiQuery({ name: 'type', required: false, type: String, description: 'Filter nodes by type', example: 'function' })
    @ApiQuery({ name: 'category', required: false, type: String, description: 'Filter nodes by category', example: 'rule_builder' })
    @ApiQuery({ name: 'sortBy', required: false, type: String, description: 'Sort nodes by specified field', example: 'created_at' })
    ...
    @ApiParam({ name: 'nodeId', description: 'Unique node identifier', example: '12' })
    @ApiResponse({ 
        status: 200, 
